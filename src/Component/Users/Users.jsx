...
const Users = () => {
    ...
    // deleteUser
    const cancelDeleteUser = () => { setIsShowDeleteModal(false) }
    ...
    const EditUserInfos = (e) => {
        ...
        axios.put(`http://localhost:8000/api/users/${userId}`, userNewInfo)
            .then(res => {
                console.log(res);
                fetchData();
    ...
    return (
        <div className='mt-10 p-5'>
            <h1 className='mb-5 text-3xl'> کاربران</h1>
