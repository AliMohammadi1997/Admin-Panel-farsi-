...
const Comments = () => {
  ...
  return (
    <div className='mt-5 md:mt-10 p-5'>
      <h1 className='mb-5  text-xl'>کامنت ها</h1>
      {allData.length ? (
      ...
      {isShowDetailsModal && (
        <DetailsModal onColse={closeDetailsModal}>
          <p className='text-lg'>{infosComment.body}</p>
        </DetailsModal>
      )}
